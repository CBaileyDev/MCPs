...
```jsonc
{
  "mcpServers": {
    ...
    "automotive-electrical": {
      "command": "node",
      "args": ["/ABS/PATH/TO/MCPs/servers/automotive-electrical/dist/index.js"]
    },
    "part-interchange": {
      "command": "node",
...
| --- | --- | --- |
| vpic, repair-info, fuel-economy-emissions, local-auto-services, tire-wheel-fitment, drivetrain-gearing, automotive-unit-converter, automotive-electrical | none | Free public data or pure math. |
